...
import stockrecommendationsystem.Rule;
        ...
        while(hasCandidate){
            ...
            for(Map.Entry<String, String> datum: data.entrySet()){
                ...
                if( oldTempRule.isEmpty() ){
                    ...
                    //Iterator iterator = oldTempRule.entrySet().iterator();
                ...
                //a.eliminateRulebyCondition1(a.rules, newTempRule);
